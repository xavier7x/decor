...
function cargarCamposFacebook(){
    $.ajax({
        async: false,
        type: "POST",
        url: $("#param_hostapp").val() + '/lib/php/facebook/facebook.php',
        dataType: 'json',
        //data: { },
        beforeSend: function(){
            $("#idprovincia").empty(); 
...
$(document).ready(function() {    
    ...
    */
    $("#formRegistro").submit(function(){
        ...
        var contrasena = $("#contrasena").val().toLowerCase();
        var confirmar_contrasena =  $("#confirmar_contrasena").val().toLowerCase();
