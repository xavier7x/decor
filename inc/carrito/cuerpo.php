                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input autocomplete="off" maxlength="90" id="nombre_envio" type="text" class="form-control" placeholder="Ingrese su nombre" required/>
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input autocomplete="off" maxlength="90" id="nombre_facturacion" type="text" class="form-control" placeholder="Ingrese su nombre" required/>
                                    </div>
                                    <div class="form-group">
