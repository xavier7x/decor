...
<head>
  ...
  <title>Ian Admin | <?php echo $pdet_valor['empresa']; ?></title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="#"><b>Bienvenido a </b><?php echo $pdet_valor['empresa']; ?></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form role="form" id="formLogin" method="post">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" id="submitFormLogin" class="btn btn-primary btn-block btn-flat">Acceder</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
