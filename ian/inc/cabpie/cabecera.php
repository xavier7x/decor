...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="inicio" class="logo">
      ...
      <span class="logo-mini"><b>I</b>AN</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Ian</b>Admin</span>
    </a>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="util/system/logoutSession.php" class="btn btn-default btn-flat">Cerrar Sesion</a>
                </div>
              </li>
            </ul>
          </li>
